            ...
            <table>
                ...
                <c:forEach var="estado" items = "${Estados}">
                    ...
                    <tr>
                        ...
                        <td>${estado.getContenido()}</td>
                        <td>${estado.getComentario()}</td>
                        <td>
                            <a href="estado?accion=Modificar">Modificar</a>
                        </td>

                        <td>
                            <form action="estado" method="post" id="eliminar${estado.getId_estado()}">
                                <input type="hidden" name="id_estado" id="id_estado" value="${estado.getId_estado()}">
                                <input type="hidden" name="accion" value="eliminar">
                                <i class="fa-solid fa-trash btnDelete" onclick="Eliminacion('${estado.getId_estado()}')"></i>
                            </form>
                        </td>
                    </tr>
